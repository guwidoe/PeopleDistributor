...
void run_random_hillclimbing_algorithm(State hill_climbing, 
  ...
  hill_climbing.print_total_num_of_contacts();
  hill_climbing.print_num_of_contacts_per_person();
  for (unsigned long int i = 0; i < num_iterations; ++i) {
    hill_climbing.try_random_m_swap_and_proceed_if_contact_delta_pos();
    hill_climbing.try_random_f_swap_and_proceed_if_contact_delta_pos();
  }
...
void run_simulated_annealing_algorithm(State simulated_annealing, 
  ...
  simulated_annealing.print_total_num_of_contacts();
  simulated_annealing.print_num_of_contacts_per_person();
